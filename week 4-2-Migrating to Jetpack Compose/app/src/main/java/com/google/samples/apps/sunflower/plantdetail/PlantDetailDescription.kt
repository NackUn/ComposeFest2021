...
@Composable
fun MockPlantDetailDescription(mockPlantDetailViewModel: MockPlantDetailViewModel) {
    val plant = mockPlantDetailViewModel.plant
...
fun PlantDetailDescriptionPreview() {
    MdcTheme {
        MockPlantDetailDescription(MockPlantDetailViewModel())
    }
}
